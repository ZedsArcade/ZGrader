...
export const es: Dictionary = {
  ...
  dashboard: {
    title: "Sus envíos",
    subtitle: "Cada carta que ha analizado y en qué punto está.",
    newSubmission: "Analizar una carta",
    loadFailed: "Error al cargar los envíos",
    emptyTitle: "Aún no hay cartas calificadas",
    emptyDescription: "Cada carta que analice aparecerá aquí.",
  ...
  submissionDetail: {
    ...
    shareUnavailable: "El enlace para compartir se desbloquea cuando hayamos revisado el informe; recibirá un correo.",

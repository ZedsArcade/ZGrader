export const en = {
  ...
  submissionDetail: {
    ...
    // The split the centering score is calculated from, shown beside it so the
    // number has something visible behind it. Taken from the combined
    // worse_side_pct, which recompute maintains -- so it follows a dismissal or
    // a moved border line rather than going stale beside them.
    centeringSplit: "Worst side",

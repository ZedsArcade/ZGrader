export const en = {
  ...
  dashboard: {
    ...
    subtitle: "Every card you've checked, and where each one stands.",
    newSubmission: "Check a card",
    loadFailed: "Failed to load submissions",
    emptyTitle: "No cards graded yet",
    emptyDescription: "Every card you check shows up here.",
  ...
  submissionDetail: {
    ...
    shareUnavailable: "The share link unlocks once we've checked the report — you'll get an email.",
  ...
  centeringAdjust: {
    ...
    instructions:
      "These four lines are where the border was detected. If one is in the wrong place, drag its handle to move it — the ratios update as you go, and the score is recalculated when you apply.",
